...
public final class connect3 extends JFrame { 
    ...
    public void addButtonsToBoard() {
        ...
        for(int i=0; i<getBoardSize(); ++i) {
            ...
            for(int j=0; j<getBoardSize(); ++j) {
                ...
                // Computer vs Player button listener
                if(numberOfPlayer==1) {
